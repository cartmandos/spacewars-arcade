...
public class GameGUI {
    ...
    public static final Image SPACESHIP_IMAGE = createImageIcon("resources/spaceship3.gif","");
    
    /** The image of the human player's spaceship with an active shield */
    public static final Image SPACESHIP_IMAGE_SHIELD = createImageIcon("resources/spaceship3_shield.gif","");
    
    /** The image of a spaceship controlled by the computer. */
    public static final Image ENEMY_SPACESHIP_IMAGE = createImageIcon("resources/spaceship2.gif","");
    
    /** The image of a spaceship controlled by the computer, with an active shield. */
    public static final Image ENEMY_SPACESHIP_IMAGE_SHIELD = createImageIcon("resources/spaceship2_shield.gif","");
    
    /** The image of a shot. */
    public static final Image SHOT_IMAGE = createImageIcon("resources/shot.gif","");
