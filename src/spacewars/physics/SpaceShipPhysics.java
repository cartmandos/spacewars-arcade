...
public class SpaceShipPhysics extends Physics {
    ...
    /**
     * Calculates the (L2) norm of the velocity vector of the ship, which is the ship's velocity.
     * 
    ...
    /**
     * Returns the maximal velocity of the ship
     * 
     * @return The maximal velocity of the ship
     */
